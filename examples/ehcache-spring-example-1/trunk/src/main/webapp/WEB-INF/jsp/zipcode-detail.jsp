...
<title>Spring-Ehcache-Annotations Weather Service Example - Weather Detail for ${zipCode }</title>
</head>
...
<p>No data available for ${zipCode }</p>
</c:when>
<c:otherwise>
<p>Detailed Weather report for ${weather.zipCode }:</p>
<ul>
